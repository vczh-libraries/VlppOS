...
TEST_FILE
{
	TEST_CASE(L"Test locale awared date/time format")
	{
	...
	TEST_CASE(L"Test locale awared string comparison")
	{
	...
	TEST_CASE(L"Test locale awared string searching")
	{
	...
	TEST_CASE(L"Test locale awared string casing")
	{
